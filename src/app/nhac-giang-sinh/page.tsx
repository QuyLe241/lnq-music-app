...
import ChonLocImg from "../../Img/trend-img6.png";
...
import { giangSinh } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 6);
  ...
  const content = giangSinh.content;
