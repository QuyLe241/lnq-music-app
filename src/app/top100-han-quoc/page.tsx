...
import ChonLocImg from "../../Img/top100-img5.png";
...
import { hanquoc } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 10);
