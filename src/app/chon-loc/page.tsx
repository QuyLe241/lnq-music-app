...
import ChonLocImg from "../../Img/trend-img3.png";
...
import { chonLoc } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 4);
