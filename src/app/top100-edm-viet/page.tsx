...
import ChonLocImg from "../../Img/trend-img1.png";
...
import { edmVN } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 12);
