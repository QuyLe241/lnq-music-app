...
import ChonLocImg from "../../Img/top100-img1.png";
...
import { hotHitVN } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 3);
  ...
  const content = hotHitVN.content;
