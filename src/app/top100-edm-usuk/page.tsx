...
import ChonLocImg from "../../Img/top100-img3.png";
...
import { edmUsUk } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 11);
