...
import ChonLocImg from "../../Img/top100-img2.png";
...
import { aumy } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 9);
