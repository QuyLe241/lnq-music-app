...
import ChonLocImg from "../../Img/trend-img4.png";
...
import { chill } from "../../utils/dataContentListSongs";
...
const PageNamePage: React.FC = () => {
  ...
  const listSongs = songs.filter((song) => song.type === 5);
